            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">(210) 555-0123</p>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">cameron@cameronhinkelrealtor.com</p>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">San Antonio & Surrounding Areas</p>
                  <p className="text-sm text-gray-500">Stone Oak, Alamo Heights, King William, and more</p>
                </div>
              </div>
